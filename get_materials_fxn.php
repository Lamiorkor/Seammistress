...
function getMaterials() {
    ...
    if ($materials) {
        ...
        foreach ($materials as $row) {
            ...
            echo "<div class='delete'><a href='../actions/delete_material_action.php?mid=" . $row['mid'] . "'><img src='../assets/delete.png' alt='delete' title='delete request' style='width: 20px;'></a></div>";
            echo "</div>";
            echo "</td>";      
            echo "</tr>";
        }
